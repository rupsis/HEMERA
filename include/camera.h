...
class camera {
 public:
  ...
  vec3 vup = vec3(0, 1, 0);            // Camera "up" direction (+Y Axis)
  ...
  void render(const hittable &world) {
    ...
    // Start from bottom left corner, scan each line left to right, top to bottom.
 ...
 private:
  ...
  void initialize() {
     ...
     * and down the vertical view port edge.
     */
